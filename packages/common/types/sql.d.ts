...
export type TableFilterOperator = '=' | '<>' | '>' | '<' | '>=' | '<=' | 'LIKE' | 'ILIKE' | 'IN' | 'IS';
...
export type TableFilterCondition = TableFilterScalarCondition | TableFilterInCondition | TableFilterIsCondition;
