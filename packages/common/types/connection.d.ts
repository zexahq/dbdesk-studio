 ...
 */
export type DBConnectionOptions = SQLConnectionOptions | MongoDBConnectionOptions | RedisConnectionOptions;
/**
 ...
 */
export type ConnectionProfile = SQLConnectionProfile | MongoDBConnectionProfile | RedisConnectionProfile;
